...
const translations = {
  en: {
    ...
    welcomeToKrishiMitra: "Welcome to KrishiMitra, your smart farming companion",
  ...
  hi: {
    ...
    welcomeToKrishiMitra: "कृषिमित्र में आपका स्वागत है, आपका स्मार्ट कृषि साथी",
